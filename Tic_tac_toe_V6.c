...
void PlayAgainstplayer (Tic_tac_toe *game);
void PlayAgainstComputer (Tic_tac_toe *game);
void PlayAgainstTrainedComputer (Tic_tac_toe *game);
...
int main (void)
{
    ...
    printf("3. Play against trained computer\n");
    scanf("%d", &game.choice);
    ...
    do
    {
        ...
        {
        case 1:
            PlayAgainstplayer(&game);
            break;
        case 2:
            PlayAgainstComputer(&game);
            break;
        case 3:
            PlayAgainstTrainedComputer(&game);
            break;
